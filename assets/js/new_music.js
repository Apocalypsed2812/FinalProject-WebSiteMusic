...
function getSongs(){
    ...
    songnew.forEach(item => {
        ...
        let lyric = item.getAttribute("data-lyric")
        ...
        return `<div class="col l-12 m-12 c-12">
                    <div class="new__music-song">
                        <div class="new__music-song-rank">
                            ...
                            <div class="new__music-song-info container__song-new" data-image="${song.image}" data-name="${song.name}" data-singer="${song.singer}" data-file="${song.file}" data-index="${index}" data-id="${song.id}" data-lyric="${song.lyric}">
